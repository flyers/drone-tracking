function [ result ] = mdnet_run_affine(images, region, net, display)
% MDNET_RUN
...
for To = 2:nFrames;
    ...
    [camera_feat, camera_H] = find_affine(camera_feat, img, targetLoc([2,1]) + targetLoc([4,3])/2, targetLoc([4,3]));
