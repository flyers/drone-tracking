...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  if (type == "accuracy") {
    ...
    return new UWConvolutionLayer<Dtype>(param);
  } else if (type == "bnll") {
  ...
  } else if (type == "ranking_loss") {
    return new RankingLossLayer<Dtype>(param);
  } else if (type == "l2hinge_loss") {
    return new L2HingeLossLayer<Dtype>(param);
  } else if (type == "concat") {
    return new ConcatLayer<Dtype>(param);
  } else if (type == "split") {
    return new SplitLayer<Dtype>(param);
  } else if (type == "cooccurance_loss"){
    return new CooccuranceLossLayer<Dtype>(param);
  } else if (type == "so_output_loss"){
    return new StructureOutputLossLayer<Dtype>(param);
  } else if (type == "window_data"){
    return new WindowDataLayer<Dtype>(param);
  } else if (type == "hdf5_input"){
  ...
  } else if (type == "cross_sample_pool"){
    return new CrossSamplePoolingLayer<Dtype>(param);
  } else if (type == "video_data"){
    return new VideoDataLayer<Dtype>(param);
  } else if (type == "multilabel_loss"){
    return new MultiLabelLogisticLossLayer<Dtype>(param);
  } else if (type == "reshape"){
    return new ReshapeLayer<Dtype>(param);
  } else if (type == "ceiling"){
    return new CeilingLayer<Dtype>(param);
  } else if (type == "feature_sparse"){
    return new FeatureSparseLayer<Dtype>(param);
  } else if (type == "mask"){
    return new MaskLayer<Dtype>(param);
  } else if (type == "voc_loss"){
    return new VOCLossLayer<Dtype>(param);
  } else {
